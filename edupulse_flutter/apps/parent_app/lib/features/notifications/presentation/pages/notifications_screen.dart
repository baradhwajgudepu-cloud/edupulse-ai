          ...
          NotificationsSuccess(:final list) => list.isEmpty
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: spacing.xs),
                          Text(
                            'No new alerts for your children.',
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // Dynamic Child name formatting
                    String titleText = notification.title;
                    if (notification.studentId != null && students.isNotEmpty) {
                      final child = students.firstWhere(
                      ...
                      if (child.firstName.isNotEmpty) {
                        ...
                        if (!titleText.contains(childName) && !titleText.contains(child.firstName)) {
                          titleText = '$titleText for $childName';
                        }
                      }
                    }
